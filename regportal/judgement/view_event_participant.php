...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/Dance-PNG.png" class="card-img-top" alt="registration image">
        </div>
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/monoact.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/mehndika.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/charcolate.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/solosong.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/openmic.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/caligraphy.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/bootwise-icon-02.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
  ...
  <div class="row">
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/groupdance.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/duetdance.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/multiscene.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/streetplay.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/gratis.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/antkshari.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/DumbCharades.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/rangoli.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/duetsong.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/battleofbands.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/storyrecitation.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
    ...
    <div class="col-md-3 mt-3">
      <div class="card text-center">
        <div class="card-header">
          <img src="../assets/images/mime.png" class="card-img-top" alt="registration image">
        </div>
        <div class="card-body mb-0">
