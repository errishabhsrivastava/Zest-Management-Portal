    ...
    <div class="col-md-12 py-1">
      <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#">
          <img src="../assets/images/tyro.png" alt="" width="70" height="30"
            class="d-inline-block align-text-top">
          <!-- <img src="../assets/images/q1.png" alt="" width="80" height="30"
            class="d-inline-block align-text-top"> -->
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto ">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link " href="profile.php" > <img width="30px"src="../assets/images/user.png"> Welcome User </a>
            </li>
            <li class="nav-item">
