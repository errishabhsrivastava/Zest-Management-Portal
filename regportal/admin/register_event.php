...
if(isset($_POST['delete_event']))
{
    ...
    $query = "DELETE FROM audience WHERE id='$student_id' AND eid!='0' ";
    ...
    <table class="table table-bordered table-hover bg-white">
      ...
      <tbody>
        ...
        <td><?php echo $row2["college"];?></td>
          ...
          <td><?php echo $ress1['event_date']," | ",$ress1['event_start_time']?></td>
          <td>
...
?>
    <!-- <img class="img" src="../assets/images/1_avatar-512.webp">  -->
    <form method="POST">
      <div class="card text-center">
        ...
        <!-- <img class="img" src="../assets/images/<?php echo $row['event_name']?>.png" alt="<?php echo $row['event_name']?>"> -->
