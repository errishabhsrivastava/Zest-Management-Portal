        ...
        <table class="table table-bordered table-hover bg-white">
          <thead>
            ...
            <th scope="col" style="width:5%">S.No.</th>
              ...
              <th scope="col" style="width:35%">Total Count PID</th>
              <!-- <th scope="col" style="width:35%">Total Count TID</th> -->
   ...
   while ($row = mysqli_fetch_assoc($retval)) {
    ?>
     ...
     <td><?php echo ++$counter; ?></td>  
      ...
      <?php 
      $sql1 = mysqli_num_rows(mysqli_query($con , "SELECT * FROM audience Where reg_event = '".$row["event_name"]."' "));?>
      <td> <?php echo $sql1?> </td>
      <!-- <td>      </td> -->
            <!-- <td>
