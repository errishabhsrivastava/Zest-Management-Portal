...
<div class="col-md-7 p-0 text-white ">
 <form action="generate_pid.php" method="POST" enctype="multipart/form-data" class="form-group" novalidate>
     ...
     <div class="row">
       <div class="col-6">
         <div class="mt-3">
           ...
           <input type="Fname" class="form-control" name = "name" id="name" placeholder="Enter Name" autocomplete="off" required>
         </div>
       </div>
       <div class="col-6">
         <div class="mt-3">
     ...
     <div class="row">
       <div class="col-6">
         <div class="mt-3">
         <label for="number">Mobile No<span style="color:#800">*</span></label>
         <input type="tel" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" class="form-control" name = "phone" id="phone"  placeholder="Enter Mobile Number" autocomplete="off" required>
     ...
     <div class="row">
       ...
       <div class="col-6">
         <div class="form-group mt-3">
           <label for="courses">Course<span style="color:#800">*</span></label>
         ...
         <div class="col-">
           <div class="form-group mt-3">
             ...
             <select class="form-control" id="college" name="college">
               ...
               <option>SRMS IPS</option>
               <option>SRMS IBS Unnao</option>
               <option>SRMS Law</option>
               <option>SRMS Nursing</option>
               <option>Bareilly International</option>
               <option>Rohilkhand University</option>
               <option>Invertis University</option>
               <option>Rajshree Medical College</option>
               <option>Rajshree Institute of Management and Technology</option>
               <option>KCMT</option>
               <option>LBS</option>
               <option>Rohilkhand Dental College</option>
               <option>MIT</option>
