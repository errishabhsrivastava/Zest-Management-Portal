...
<nav class="navbar navbar-expand-lg navbar-dark">
  <div class="container">
  <img src="../assets/images/tyro.png" width="70px">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 navbar-right">
        <li class="nav-link" style="font-family:'Nosifer';font-color:white;"><a href="index.php">Home</a>            </li>
            ...
            <li class="nav-link"><a href="../regportal\index.php"  style="font-family:'Nosifer';font-color:white;">Registration</a></li>
            <li class="nav-link"><a href="contact.php"  style="font-family:'Nosifer';font-color:white;">Contacts</a></li>
                ...
                <a href="https://www.srms.ac.in/"><img src="../assets/images/q.png" width="100px"></a>
